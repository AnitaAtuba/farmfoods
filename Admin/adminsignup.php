...
<div class="my-4">
<h2 class="mb-3 text-success text-center">FarmFoods Admin</h2>
	<?php 
...
<div class="row mb-2">
	<div class="col-12">
<label for="email" class="col-form-label text-success">Email:</label>
</div>
<div class="col">
<input type="email" class="form-control text-success" id="email" name="email" >
</div>
</div>
</div>
...
<button type="submit" name="btn" class="button col-12 btn mb-4">Sign up</button>
</div>
</form>
</div>
</section>
