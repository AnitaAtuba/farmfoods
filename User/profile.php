...
<section>
	...
	<div class="col me-auto acct p-2 border border-subtle mb-2">
			...
			<div class="mt-3 border border-subtle p-2">
				...
				<h6 class="mb-2"><strong>Shipping Address 1:</strong></h6>
			<span><?php echo $deets['user_addr1'] ?></span>
			<div>
				<h6 class="mb-2"><strong>Shipping Address 2:</strong></h6>
