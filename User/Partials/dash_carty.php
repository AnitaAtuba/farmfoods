...
<section>
	<div class="row mt-3 ">																			
		...
		<a class=" btn btn-success align-items-center col-md-6 " data-bs-toggle="offcanvas" href="#offcanvasExample" role="button" aria-controls="offcanvasExample"><i class="fa-solid fa-bars text-white"></i> FarmFoods</a>
...
<div class="col-8"  id="">
	<form class="d-flex align-items-center" role="search" method="post">
			<input class="form-control" type="search" placeholder="search FarmFoods" aria-label="Search" name="search" id="search"/>
			<!-- <button type="button" id="searchbtn" name="searchbtn"  class="ms-1 d-flex justify-content-center align-items-center btn btn-outline-success col-4">Search</button> -->
		</form>
